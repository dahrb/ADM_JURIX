#!/usr/bin/env python3
"""
Split ADM Visualization with All Dependencies
Creates separate images with connection boxes and all sub-ADM dependencies
"""
...
def create_inventive_step_split_with_all_dependencies():
    """
    Create split visualizations for Inventive Step ADM with all dependencies
    """
    print("=" * 60)
    print("INVENTIVE STEP ADM - SPLIT WITH ALL DEPENDENCIES")
    print("=" * 60)
...
def main():
    """
    Generate split visualizations for Inventive Step ADM with all dependencies
    """
    print("Creating split Inventive Step ADM visualizations...")
    print("Main ADM includes all sub-ADM dependencies and connections")
    
    try:
        sub_adm_count = create_inventive_step_split_with_all_dependencies()
